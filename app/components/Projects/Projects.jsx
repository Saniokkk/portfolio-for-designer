    ...
    <section className={s.section}>
      <Container className={s.container}>
        ...
        <Text className={s.description}>
          I use Figma for my online work, so you&#39;ll always be up to date on
          the entire process.{" "}
          <span className={s.accentText}>
            Your main focus is business development, and my task is to ensure
            effective digital representation and stand out from the competition.
            I guarantee to make sure that your business looks impressive and
            meets your expectations. Let&#39;s craft something truly special and
            creative together.
          </span>
        </Text>
      </Container>
